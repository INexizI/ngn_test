...
internal void
CastStrings(size_t SourceACount, char *SourceA,
...
{
    CastStrings(State->OnePastLastEXEFileNameSlash - State->EXEFileName, State->EXEFileName,
                           ...
                           HDC DeviceContext, int WindowWidth, int WindowHeight)
{
    ...
    PatBlt(DeviceContext, 0, 0, WindowWidth, OffsetX, BLACKNESS);
...
{
    char Temp[64];
    wsprintf(Temp, "loop_edit_%d_%s.ei", SlotIndex, InputStream ? "input" : "state");
        ...
        int ShowCode)
{
    ...
    Win32BuildEXEPathFileName(&Win32State, "engine.dll",
                ...
                while(GlobalRunning)
                {
                    ...
                    *NewKeyboardController = {};
                    ...
                    if(!GlobalPause)
                    {
                        ...
                        NewInput->MouseZ = 0; // TODO(D): Support mousewheel?
